In this project i learned to write Bash scripts to automate my work. All scripts were designed to configure a brand new Ubuntu server to match the task requirements
